...
object) and Redis (backs the preview cache and the circuit breaker). No
authentication — this is called by container healthchecks and
monitoring, never through the gateway's ``auth_request``.
"""
